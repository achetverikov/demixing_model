...
def prepare_panel(args) -> None:
    ...
    commands = [
        [str(python), "continuous_density/generate_training_data.py",
        ...
        [str(python), "continuous_density/compare_existing_model.py",
        ...
        [str(python), "continuous_density/stratified_forward_truth.py", "summarize",
