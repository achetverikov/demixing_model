...
Calibration sweeps and negative controls used while designing a fixture normally belong in development notes, not in the maintained suite. Do not keep tests whose main purpose is to test the test oracle.
