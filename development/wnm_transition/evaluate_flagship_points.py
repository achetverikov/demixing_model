...
def main() -> None:
    ...
    for point in points:
        ...
        for component in args.components:
            ...
            _run([sys.executable, "-m", "development.wnm_representation.bootstrap_local_metrics",
            ...
            _run([sys.executable, "-m", "development.wnm_representation.local_distribution_gate",
